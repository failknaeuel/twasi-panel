export default {
  ...
  'rank.team': 'Team member',
  'rank.partner': 'Partner streamer',
  ...
  'overview.no_streams_tracked_subtitle': 'Start a stream with Twasi in your channel and Twasi will collect data from your stream to display it here.',
  ...
  'plugins.explanation': 'Plugins are extentions for Twasi. It is up to you to decide which plugins you want to install or uninstall for your own bot.',
  ...
  'plugins.documentation.subheadline': 'If you detect a mistake in the documentation, please use the feedback function to submit the mistake.',
  ...
  'moderators.table.permissions.songrequests': 'Song requests',
  ...
  'profile.social_subline': 'Here you can link your Social Media. Plugins can use information from connected accounts if you want to.',
  ...
  'feedbackswitch.subheadline': 'You want to make Twasi an even better place? Here you can give feedback, tell us your idea or report a bug.',
  ...
  'urlshortener.subheadline': 'Shorten your URL to share it with your community.',
  ...
  'urlshortener.headline_urls': 'Here you can find an overview of already shortened URLs.',
  'urlshortener.shortlink': 'Shortlink',
  'urlshortener.redirection': 'Redirection',

  // Support
  'support.new_ticket': 'New support ticket',
  'support.new_ticket_subheadline': 'You are about to open a new support ticket. Please give us detailed information about your problem so we can give you the best possible answers.',
  ...
  'support.open.no_tickets.subtitle': 'Either you have not opened a ticket yet or we already finished all of your tickets. In this case, please look under \"Closed tickets\".',
